    ...
    <Layout>
        ...
        <Link key={slug} to= {'/ongoingProject/${slug}'}>
            {ongoingProject.projectName}
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                <div class="project-box" >
                                    ...
                                    <div class="project-box-contents">
                                        <div class="project-duration">5-12 month</div>
                                        ...
                                        <p class="project-description">Monenco Insights; a mobile application providing an access to the articles and white papers prepared by Monenco.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                <div class="project-box">
                                    <h2 class="project-title">Ps home: brand identity</h2>
                                    <div class="divider-line"></div>
                                    <div class="project-box-contents">
                                        <div class="project-duration">3-5 month</div>
                                        <div class="project-budget">70 milion Toman</div>
                                        <div class="project-user-story">Available</div>
                                        <div class="project-skill">
                                        ...
                                        <p class="project-description">a platform to ease the access for clients to reach electricians anytime and anywhere in Canada
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                <div class="project-box">
                                    ...
                                    <div class="project-box-contents">
                                        ...
                                        <p class="project-description">A platform for institutions and lecturers to provide the audience their video courses in art topics</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=" col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <div class="how-it-works-first-step">
                                <div class="set">
                                    ...
                                    <p class="how-it-works-details">Set a meeting time. Feel comfortable to choose an
                        ...
                        <div class=" col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <div class="how-it-works-second-step">
                                <div class="scope">
                                    ...
                                    <p class="how-it-works-details">Your product manager will help you clarify your scope of
