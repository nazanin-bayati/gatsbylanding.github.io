    ...
    return (
        <footer id="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p class="call-to-action-content"> Looking to hire for long-term or full-time assignments? Hire
                            top
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <ul id="footer-content">
                            ...
                            <li class="footer-details" onclick="location.href='/projects/submit/category'">Privacy &
                                Policy
                            </li>
                        </ul>
                    </div>
